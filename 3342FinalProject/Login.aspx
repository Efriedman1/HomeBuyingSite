        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            ...
            <div class="card" style="width: 25rem; margin-top: 150px;">
                <div class="card-body">
                    ...
                    <asp:TextBox ID="inputUsername" runat="server" class="form-control" placeholder="Username" autofocus=""></asp:TextBox>
                    <p><asp:RadioButtonList ID="selectAccountType" runat="server" CssClass="text-left">
